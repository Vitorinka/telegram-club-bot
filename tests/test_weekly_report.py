...
class WeeklyReportTest(unittest.TestCase):
    ...
    def test_source_payment_event_requirements(self):
        ...
        link_only_end = source.index("days_to_add = parse_checkout_days", link_only_start)
    ...
    def test_manual_link_zero_invoice_is_resolved_without_payment_event(self):
        ...
        link_block = source[link_start:source.index("@router.message(Command('unban_user')", link_start)]
